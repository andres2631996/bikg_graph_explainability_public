...
project = "graph_interpretability"
copyright = f"{date.today().year}, Andrés Martínez Mora"
...
modindex_common_prefix = ["graph_interpretability."]
...
htmlhelp_basename = "graph_interpretabilitydoc"
...
#     (
#         master_doc,
#         'graph_interpretability.tex',
#         'graph_interpretability Documentation',
#         author,
#         'manual',
#     ),
# ]
...
texinfo_documents = [
    (
        ...
        "Library that runs several interpretability methods on top of graph machine learning methods",
        "Miscellaneous",
    ),
]
